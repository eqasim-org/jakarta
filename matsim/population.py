...
class PersonWriter:
    ...
    def write(self, writer):
        ...
        writer.add_attribute("isPassenger", "java.lang.Boolean", writer.true_false(self.person[8]))
        writer.add_attribute("carAvailability", "java.lang.String", "always" if self.person[9] else "never")
        writer.add_attribute("hhlIncome", "java.lang.Double", str(self.person[10]))
...
PERSON_FIELDS = ["person_id", "age", "sex", "employment", "binary_student", "census_person_id", "hts_person_id", "is_passenger", "binary_car_availability", "hhIncome"] #, "income" , "is_passenger" , "employment", "census_person_id", "sex"
